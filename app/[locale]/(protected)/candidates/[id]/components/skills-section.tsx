...
import { SkillSectionProps } from "../../types/candidate-detail-types";
...
const SkillsSection = ({
  ...
  const groupedSkills = skills?.reduce((acc, skill) => {
    ...
    return acc;
  }, {} as Record<string, SkillSectionProps[]>);
    ...
    <Card>
      ...
      <CardContent className="pt-4 space-y-6">
        {categories.map((category) => {
          const categorySkills = groupedSkills && groupedSkills[category] ? groupedSkills[category] : [];

        ...
        <Card className="col-span-12 xl:col-span-5">
          ...
          <CardContent className="p-6">
            ...
            <p className="text-sm text-default-600 mt-4">
              Amet minim mollit non deserunt ullamco est sit aliqua dolor do
              amet sint.The Optimistic Website Company. Amet minim mollit non
              deserunt ullamco est sit aliqua dolor do amet sint.The Optimistic
            ...
            <div className="bg-default-100  rounded px-4 pt-4 pb-1 flex flex-wrap justify-between mt-6">
              <div className="me-3 mb-3 space-y-2">
                ...
                <div className="text-xs text-default-600">John Doe</div>
              </div>
              <div className="me-3 mb-3 space-y-2">
                <div className="text-xs font-medium text-default-600">
                  Budget
                </div>
                <div className="text-xs text-default-600 ">$75,800</div>
              </div>
              <div className="me-3 mb-3 space-y-2">
                <div className="text-xs font-medium text-default-600">
                  Start date
                </div>
                <div className="text-xs text-default-600">01/11/2021</div>
              </div>
              <div className="me-3 mb-3 space-y-2">
                <div className="text-xs font-medium text-default-600 ">
                  Deadline
